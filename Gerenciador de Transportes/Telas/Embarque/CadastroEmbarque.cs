...
namespace Gerenciador_de_Transportes
{
    public partial class CadastroEmbarque : Form
    {
        ...
        {
            leSelects();
            if (usuarioLogado.ToLower() == "tsjean")
            {
                tb_cliente.Enabled = true;
                tb_destinatario.Enabled = true;
                tb_embarcador.Enabled = true;
                tb_km.Enabled = true;
                tb_placaCarreta.Enabled = true;
                tb_placaCarretaDois.Enabled = true;
                tb_proprietario.Enabled = true;
                tb_freteFiscal.Enabled = true;
                tb_icms.Enabled = true;
                tb_pedagio.Enabled = true;
                tb_classificacao.Enabled = true;
                tb_cidadeOrigem.Enabled = true;
                tb_cidadeDestino.Enabled = true;
                tb_estadoDestino.Enabled = true;
                tb_estadoOrigem.Enabled = true;
            }
        ...
        private void btn_cadastrar_Click(object sender, EventArgs e)
        {
            ...
            {
                ModalAlerta modal = new ModalAlerta("Atenção!", "Pedido e placa cavalo são obrigatorios!");
                modal.ShowDialog();
            }
            else
            {
