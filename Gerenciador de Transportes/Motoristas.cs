...
namespace Gerenciador_de_Transportes
{
    public partial class Motoristas : Form
    {
        ...
        {
            BancoDeDados.alterarItemMotorista(placa, tb_moto1.Text, tb_moto2.Text, tb_moto3.Text, tb_moto4.Text, tb_moto5.Text, tb_moto6.Text, tb_moto7.Text, tb_moto8.Text, tb_moto9.Text, tb_moto10.Text, tb_moto11.Text, tb_moto12.Text, usuarioLogado);
            Boolean semUso = leMotoristas();
            tb_moto1.Text = itens[0];
            tb_moto2.Text = itens[1];
            tb_moto3.Text = itens[2];
