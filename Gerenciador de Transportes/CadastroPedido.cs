    ...
    public partial class CadastroPedido : Form
    {
        ...
        private void btn_cadastrar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                retorno = BancoDeDados.adicionarPedido(tb_Pedido.Text, sl_rota.Text, tb_freteFiscal.Text, tb_Icms.Text, tb_Pedagio.Text, tb_Classificao.Text, tb_Km.Text, tb_Cliente.Text, split[0], sl_EstadoEmbarcador.Text, tb_destinatario.Text, sl_estadoDestinatario.Text, tb_freteMotorista.Text, tb_cidadeOrigem.Text, tb_cidadeDestino.Text, usuarioLogado);
                if (!retorno)
                {
